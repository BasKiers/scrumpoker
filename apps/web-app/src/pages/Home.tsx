    ...
    <div className="min-h-screen bg-[#f7f8fa] flex flex-col">
      <header className="bg-[#f7f8fa]">
        <div className="container mx-auto px-4 py-3">
          <h1 className="text-2xl font-bold tracking-tight text-gray-800">Scrum Poker</h1>
        </div>
      </header>
      <main className="flex-1 flex justify-center px-2">
        <div className="w-full max-w-7xl bg-white rounded-t-2xl shadow-xl p-8">
          <section className="flex flex-col items-center justify-center text-center space-y-8 py-8">
